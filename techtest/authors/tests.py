...
class AuthorListViewTestCase(TestCase):
    def setUp(self):
        ...
        self.author_1 = Author.objects.create(first_name="Joe", last_name="Doe")
        self.author_2 = Author.objects.create(first_name="Max", last_name="Luis")
...
class AuthorViewTestCase(TestCase):
    def setUp(self):
        self.author = Author.objects.create(code="AL", name="Albania")
